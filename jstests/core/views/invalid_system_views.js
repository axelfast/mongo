...
(function() {
    ...
    function runTest(badViewDefinition) {
        ...
        if (!isMongers) {
            ...
            // presence of invalid views. However, applyOps doesn't work on mongers.
        ...
        if (isMongers || storageEngine === "ephemeralForTest" || storageEngine === "inMemory" ||
            storageEngine === "biggie") {
            print("Not testing compact command on mongers or ephemeral storage engine");
        } else {
