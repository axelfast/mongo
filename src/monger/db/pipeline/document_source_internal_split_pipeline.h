 ...
 * one of 'primaryShard', 'anyShard' or 'mongers' to control where the merge may occur. Omitting this
 * parameter or specifying 'mongers' produces the default merging behaviour; the merge half of the
 * pipeline will be executed on mongerS if all other stages are eligible, and will be sent to a
...
public:
    ...
    StageConstraints constraints(Pipeline::SplitState pipeState) const final {
        return {StreamType::kStreaming,
                ...
                _mergeType == HostTypeRequirement::kMongerS ? LookupRequirement::kNotAllowed
