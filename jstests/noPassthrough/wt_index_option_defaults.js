...
(function() {
    ...
    // TODO: This test can be enabled when MongerRunner supports combining WT config strings with
    // commas.
    ...
    // Start up a mongerd with system-wide defaults for index options and create a collection without
    ...
    // Start up a mongerd with system-wide defaults for index options and create a collection with
    ...
    function runTest(collOptions) {
        ...
        var dbpath = MongerRunner.dataPath + 'wt_index_option_defaults';
        resetDbpath(dbpath);

        // Start a mongerd with system-wide defaults for engine-specific index options.
