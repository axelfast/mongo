...
var mongerOptions = {auth: null, keyFile: "jstests/libs/key1"};
var authErrCode = 13;
...
var nodes = rs.startSet(mongerOptions);
rs.initiate();
...
rs = new ReplSetTest({name: rsName, nodes: 1, nodeOptions: mongerOptions});
nodes = rs.startSet();
rs.initiate();
authutil.asCluster(nodes, "jstests/libs/key1", function() {
    rs.awaitReplication();
