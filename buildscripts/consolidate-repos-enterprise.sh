...
# Examples:
#
# /var/www-enterprise/repo.consolidated/yum/redhat/5/mongerdb-enterprise/unstable -> 2.5
# /var/www-enterprise/repo.consolidated/yum/redhat/6/mongerdb-enterprise/unstable -> 2.5
# /var/www-enterprise/repo.consolidated/apt/ubuntu/dists/precise/mongerdb-enterprise/unstable -> 2.5
# /var/www-enterprise/repo.consolidated/apt/debian/dists/wheezy/mongerdb-enterprise/unstable -> 2.5
#
