...
# Usage:
# python3.7 mongers-pin-auto-tests.py > mongers-pin-auto.yml
if sys.version_info[:2] < (3, 7):
    print('ERROR: This script requires Python >= 3.7, not:')
    print(sys.version)
    print('Usage: python3.7 mongers-pin-auto-tests.py > mongers-pin-auto.yml')
    exit(1)

HEADER = '''# Autogenerated tests that transient errors in a transaction unpin the session.
# See mongers-pin-auto-tests.py
topology: [sharded]
...
tests:
  ...
  - description: unpin after transient error within a transaction
    ...
    operations:
      ...
      # Session unpins from the first mongers after the insert error and
      # abortTransaction succeeds immediately on any mongers.
