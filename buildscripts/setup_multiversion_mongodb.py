...
class MultiVersionDownloader(object):  # pylint: disable=too-many-instance-attributes
    ...
    def download_links(self):
        ...
        download_file("https://downloads.mongerdb.org/full.json", temp_file)
...
Downloads and installs particular mongerdb versions (each binary is renamed
...
Usage: setup_multiversion_mongerdb.py [options] ver1 [vers2 ...]

Ex: setup_multiversion_mongerdb.py --installDir ./install
                                  --linkDir ./link
                                  --edition base
...
After running the script you will have a directory structure like this:
    ./install/[mongerdb-osx-x86_64-2.4.9, mongerdb-osx-x86_64-2.2.7]
    ./link/[mongerd-2.4.9, mongerd-2.2.7, monger-2.4.9...]
