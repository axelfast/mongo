...
(function() {
    ...
    var st = new ShardingTest({mongers: 2, shards: 2});

    // enableSharding can run only on mongers.
    ...
    // Calling 'enableSharding' on one mongers and 'shardCollection' through another must work
