...
# newline-separated language file in source/monger_sources/languages.txt.  This language file must
...
# versions of ICU does not contain all the collations needed by mongerdb. If this script fails while
...
#      $(pwd)/src/third_party/icu4c-57.1/source/monger_sources/icudt57l.dat
#
...
MONGO_SOURCES_DIR="${ICU_THIRD_PARTY_DIR}/source/monger_sources"
