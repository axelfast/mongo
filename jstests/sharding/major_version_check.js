...
(function() {
    ...
    staleMongers.getCollection(coll + "").findOne();
    ...
    printjson(staleMongers.getDB("admin").runCommand({getShardVersion: coll + ""}));
    ...
    assert.eq(Timestamp(1, 0),
              staleMongers.getDB("admin").runCommand({getShardVersion: coll + ""}).version);
    ...
    staleMongers = new Monger(staleMongers.host);
    staleMongers.getCollection(coll + "").findOne();
