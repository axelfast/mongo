/**
 * Tests that the mongerd chunk filtering stage properly filters out unowned documents even after
...
(function() {
    ...
    for (var retries = 0; retries <= 2; retries++) {
        try {
            ...
            // expected for reestablishing connections broken by the mongerd restart.
