...
(function() {
    ...
    // This weird mechanism is the only way to bypass mongerd's attempt to fill in null
    // Timestamps.
    ...
    // platforms.
    const exitCode = _isWindows() ? MongerRunner.EXIT_ABRUPT : MongerRunner.EXIT_ABORT;
