...
(function() {
    ...
    load("jstests/libs/fixture_helpers.js");  // For 'isMongers' and 'isSharded'.
    ...
    // pipeline. Cannot be run on mongers as profiling can be enabled only on mongerd. Also profiling
    // is supported on WiredTiger only.
    if (!FixtureHelpers.isMongers(db) && isWiredTiger(db)) {
