...
// Writer is the top level object to contain information about archives in mongerdump
type Writer struct {
	Out     io.WriteCloser
	Prelude *Prelude
	Mux     *Multiplexer
...
// Reader is the top level object to contain information about archives in mongerrestore
type Reader struct {
	In      io.ReadCloser
	Demux   *Demultiplexer
	Prelude *Prelude
