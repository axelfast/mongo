 ...
 *  tree, and Elements of proper type (monger::Object or monger::Array) may have child
 ...
 *  for children (i.e. it represents a monger::Array or monger::Object) it may have child
 ...
 *  Example 1: Building up a document from scratch, reworking it, and then serializing it:
     ...
     doc.writeTo(&builder);
     monger::BSONObj result = builder.obj();
...
public:
    ...
    Element makeElementOID(StringData fieldName, monger::OID value);
    ...
    Element makeElementDBRef(StringData fieldName, StringData ns, monger::OID oid);
