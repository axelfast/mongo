/**
 * Test runner responsible for parsing and executing a MQL MongerD model test json file.
 */
(function() {
    "use strict";
    ...
    testList.forEach(function(singleTest) {
        if (singleTest.hasOwnProperty("match")) {
            // Skip the match test type as it is not directly supported by mongerd.
