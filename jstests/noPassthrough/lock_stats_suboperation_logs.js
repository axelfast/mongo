/**
 * This test checks that mongerd correctly logs report the lockStats for sub-operations. Before
 ...
 *  4. FsyncUnlock.
 *  5. Check the mongerd logs: only that sub-operation (createCollection) and the 'parent' operation
