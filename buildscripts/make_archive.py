...
src/monger/foo.cpp and build/linux2/normal/buildinfo.cpp can get put into the same
directory in the archive, perhaps mongerdb-2.0.2/src/monger.
...
For a detailed usage example, see src/SConscript.client or src/monger/SConscript.
"""
...
def make_tar_archive(opts):
    ...
    e.g. for an input file named "a/monger/build/DISTSRC", and an
    existing transformation {"a/monger/build": "release"}, the input
