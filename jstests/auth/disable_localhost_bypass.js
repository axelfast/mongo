var conn1 = MongerRunner.runMongerd({auth: "", setParameter: "enableLocalhostAuthBypass=true"});
var conn2 = MongerRunner.runMongerd({auth: "", setParameter: "enableLocalhostAuthBypass=false"});
...
MongerRunner.stopMongerd(conn1, null, {user: "root", pwd: "pass"});
MongerRunner.stopMongerd(conn2, null, {user: "root", pwd: "pass"});
