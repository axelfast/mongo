...
// Package command contains abstractions for operations that can be performed against a MongerDB
// deployment. The types in this package are meant to provide a general set of commands that a
// user can run against a MongerDB database without knowing the version of the database.
//
