// Test resuming a change stream on a mongers other than the one the change stream was started on.
...
(function() {
    ...
    for (let key of Object.keys(ChangeStreamWatchMode)) {
        ...
        // Now resume using the resume token from the first change on a different mongers.
        const otherCst =
