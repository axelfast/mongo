...
var strictCRS = {type: "name", properties: {name: "urn:x-mongerdb:crs:strictwinding:EPSG:4326"}};
// invalid CRS name
var badCRS = {type: "name", properties: {name: "urn:x-mongerdb:crs:invalid:EPSG:4326"}};
...
indexes.forEach(function(index) {
    ...
    polys.forEach(function(p) {
        ...
        if (coll.getMonger().writeMode() == "commands") {
