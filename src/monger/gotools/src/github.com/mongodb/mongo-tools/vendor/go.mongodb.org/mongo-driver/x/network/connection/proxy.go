...
import "go.mongerdb.org/monger-driver/x/network/wiremessage"

// Proxy implements a MongerDB proxy. It will use the given pool to connect to a
// MongerDB server and proxy the traffic between connections it is given and the
