 ...
 * primary or mongers instance. 'secondary' is the shard/replica set secondary. If 'db' is backed
 * by a mongers instance then the associated cluster should have only a single shard. 'rst' is the
