...
(function() {
     ...
     *
     * Transforms the explain output so that if it came from a mongers, it will be modified
     * to have the same format as though it had come from a mongerd.
     */
    ...
    function assertDBDoesNotExist(db, msg) {
        assert.eq(db.getMonger().getDBNames().indexOf(db.getName()),
                  -1,
