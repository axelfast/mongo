...
(function() {
    ...
    var normalShard = MongerRunner.runMongerd({shardsvr: ''});
    ...
    let standalone1 = MongerRunner.runMongerd({shardsvr: ''});
    ...
    st.stop();
    MongerRunner.stopMongerd(normalShard);
