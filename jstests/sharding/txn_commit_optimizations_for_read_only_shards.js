...
(function() {
    ...
    // Waits for the given log to appear a number of times in the shell's rawMongerProgramOutput.
    ...
    function waitForLog(logLine, times) {
        assert.soon(function() {
            const matches = rawMongerProgramOutput().match(new RegExp(logLine, "g")) || [];
