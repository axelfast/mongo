# MongerDB Voluntary Product Accessibility Template® (VPAT™)

Contact for more Information: https://www.mongerdb.com/contact
...
|Criteria |Supporting Features|Remarks and explanations|
|---|---|---|
|(a) A text equivalent for every non-text element shall be provided (e.g., via "alt", "longdesc", or in element content).|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/.|
|(b) Equivalent alternatives for any multimedia presentation shall be synchronized with the presentation.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/.|
|(c\) Web pages shall be designed so that all information conveyed with color is also available without color, for example from context or markup.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(d) Documents shall be organized so they are readable without requiring an associated style sheet.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(e) Redundant text links shall be provided for each active region of a server-side image map.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(f) Client-side image maps shall be provided instead of server-side image maps except where the regions cannot be defined with an available geometric shape.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(g) Row and column headers shall be identified for data tables.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(h) Markup shall be used to associate data cells and header cells for data tables that have two or more logical levels of row or column headers.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(i) Frames shall be titled with text that facilitates frame identification and navigation|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(j) Pages shall be designed to avoid causing the screen to flicker with a frequency greater than 2 Hz and lower than 55 Hz.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(k) A text-only page, with equivalent information or functionality, shall be provided to make a web site comply with the provisions of this part, when compliance cannot be accomplished in any other way. The content of the text-only page shall be updated whenever the primary page changes.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/.|
|(l) When pages utilize scripting languages to display content, or to create interface elements, the information provided by the script shall be identified with functional text that can be read by Assistive Technology.|Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(m) When a web page requires that an applet, plug-in or other application be present on the client system to interpret page content, the page must provide a link to a plug-in or applet that complies with §1194.21(a) through (l). |Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(n) When electronic forms are designed to be completed on-line, the form shall allow people using Assistive Technology to access the information, field elements, and functionality required for completion and submission of the form, including all directions and cues. |Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(o) A method shall be provided that permits users to skip repetitive navigation links. |Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
|(p\) When a timed response is required, the user shall be alerted and given sufficient time to indicate more time is required. |Core MongerDB documentation has been coded to meet this standard subject to the remarks on the right. |Our documentation complies to this criteria and can be found at https://docs.mongerdb.com/manual/. |
