// Verifies mongers uses a versioned routing table to target subsequent requests in transactions with
...
(function() {
    ...
    const st = new ShardingTest({shards: 3, mongers: 1, config: 1});
