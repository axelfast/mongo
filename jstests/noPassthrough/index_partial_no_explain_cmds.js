...
// mongerd with the --notablescan flag set, so that they fail if the index is not used.
(function() {
    "use strict";
    var runner = MongerRunner.runMongerd({setParameter: "notablescan=1"});
    ...
    MongerRunner.stopMongerd(runner);
})();
