...
(function() {
    ...
    //
    // Stop the mongerd and then restart it, this time with profiling enabled. Note that enabling
    ...
    //
    // The mongerd should print out a warning to indicate the potential need for a manually created
    // 'system.profile' collection.
    //
    checkLog.contains(standalone, "Manually create profile collection");

    //
    // The mongerd should not create the 'system.profile' collection automatically.
    //
