...
(function() {
    ...
    replTest.stop(initSyncNode, undefined, {allowedExitCode: MongerRunner.EXIT_ABRUPT});
    ...
    assert(rawMongerProgramOutput().match(msgInvalidOption) &&
               rawMongerProgramOutput().match(msgInitialSyncFatalAssertion),
