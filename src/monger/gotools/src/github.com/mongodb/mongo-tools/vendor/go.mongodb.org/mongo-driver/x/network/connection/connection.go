...
// MongerDB Wire Protocol. Since this low level library is meant to be used in the context of either
...
// Handshaker is the interface implemented by types that can perform a MongerDB
