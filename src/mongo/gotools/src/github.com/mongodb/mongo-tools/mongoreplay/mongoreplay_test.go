...
func TestOpGetMore(t *testing.T) {
	...
	op := GetMoreOp{}
	op.Collection = "mongerreplay_test.test"
	op.CursorId = 12345
	op.Limit = -1
	...
	switch {
	case getMoreOp.Collection != "mongerreplay_test.test":
		t.Errorf("Collection not matched. Saw %v -- Expected %v\n", getMoreOp.Collection, "mongerreplay_test.test")
...
func TestOpDelete(t *testing.T) {
	...
	switch {
	case deleteOp.Collection != "mongerreplay_test.test":
		t.Errorf("Collection not matched. Saw %v -- Expected %v\n", deleteOp.Collection, "mongerreplay_test.test")
...
func TestInsertOp(t *testing.T) {
	...
	switch {
	case insertOp.Collection != "mongerreplay_test.test":
		t.Errorf("Collection not matched. Saw %v -- Expected %v\n", insertOp.Collection, "mongerreplay_test.test")
