...
// so this ensures that both the Collection and DB helpers will actually call the Monger function.
// Although calls to the shell helpers will ultimately resolve to the overridden runCommand anyway,
// we need to override the helper to ensure that the Monger.watch function itself is exercised by the
...
DB.prototype.watch = function(pipeline, options) {
    ...
    return this.getMonger().watch(pipeline, options);
};
