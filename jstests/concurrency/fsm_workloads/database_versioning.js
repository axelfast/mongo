...
var $config = (function() {
    ...
    function teardown(db, collName, cluster) {
        ...
        // If this workload is run with --repeat, mongers will already have all the database entries
        // cached. Because of SERVER-xxx (mongers does not mark its database entry as invalid on
        // CannotImplicitlyCreateCollection), this mongers will never realize the databases have been
        ...
        // As a temporary workaround, flush mongers's cache at the end of each workload.
