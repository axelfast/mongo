...
/**
 * Class representing the context of a service, such as a MongerD database service or
 * a MongerS routing service.
 *
...
public:
    ...
    public:
         ...
         * "name" and no prerequisite constructors or monger initializers.
         */
