...
/**
 * The ntservice namespace provides minimal support for running monger servers as NT services.
 *
...
/**
 * Construct an argv array that Windows should use to start mongerd/mongers as a service
 * if monger was started with "inputArgv", which is assumed to be an argument vector that
 * dictates that Windows should install monger as a service.
 *
 * The result is suitable for passing to monger::constructUtf8WindowsCommandLine() to construct
