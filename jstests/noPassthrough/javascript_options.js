...
testGetCmdLineOptsMongerd({noscripting: ""}, expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/disable_noscripting.ini"},
                         expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/enable_scripting.json"},
                         expectedResult);
