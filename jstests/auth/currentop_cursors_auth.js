...
(function() {
    ...
    // Run the various auth tests on the given shard or mongerS connection.
    ...
    jsTestLog("Running cursor tests on mongerD");
    runCursorTests(shardConn);

    jsTestLog("Running cursor tests on mongerS");
    runCursorTests(mongersConn);
