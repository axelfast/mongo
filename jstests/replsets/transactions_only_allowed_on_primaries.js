...
(function() {
    ...
    const secondarySession = secondary.getDB(dbName).getMonger().startSession(sessionOptions);
    ...
    const primarySession = primary.getDB(dbName).getMonger().startSession(sessionOptions);
