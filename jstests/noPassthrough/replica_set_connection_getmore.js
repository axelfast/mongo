/**
 * Tests the behavior of how getMore operations are routed by the monger shell when using a replica
...
(function() {
    ...
    assert.eq("commands",
              conn.readMode(),
              "replica set connections created by the monger shell should use 'commands' read mode");
