// Tests mongers behavior when reading against views in a transaction.
//
// @tags: [
...
(function() {
    ...
    //
    // This may happen when reading from a sharded view, because mongers will target the primary
