/**
 * Test issuing raw find and getMore commands to mongers using db.runCommand().
 */
(function() {
    "use strict";
    ...
    // getMore is required between mongers and the shell, but no getMores are issued between mongers
    // and mongerd.
    ...
    // will be issued between mongers and mongerd.
    ...
    // Ensure textScore meta-sort works in mongers.
    cmdRes = db.runCommand({
        find: coll.getName(),
