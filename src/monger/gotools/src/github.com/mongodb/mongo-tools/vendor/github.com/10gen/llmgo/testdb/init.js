...
function configShards() {
    cfg1 = new Monger("127.0.0.1:40201").getDB("admin")
    cfg1.runCommand({addshard: "127.0.0.1:40001"})
    cfg1.runCommand({addshard: "rs1/127.0.0.1:40011"})

    cfg2 = new Monger("127.0.0.1:40202").getDB("admin")
    cfg2.runCommand({addshard: "rs2/127.0.0.1:40021"})

    cfg3 = new Monger("127.0.0.1:40203").getDB("admin")
...
function configAuth() {
    ...
    for (var i in addrs) {
        ...
        var db = new Monger(addrs[i]).getDB("admin")
