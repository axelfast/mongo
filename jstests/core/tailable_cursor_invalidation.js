...
(function() {
    ...
    if (isMongers) {
        // Mongers will let you establish a cursor with batch size 0 and return to you before it
        ...
        // A mongerd should know immediately that the collection doesn't exist, and return a 0 cursor
        // id.
