...
(function() {
    ...
    assert.commandWorked(mongers.adminCommand({shardCollection: 'TestDB.TestColl', key: {Key: 1}}));

    var coll = mongers.getDB('TestDB').TestColl;
    ...
    var staticMongerd = MongerRunner.runMongerd({});

    var joinMoveChunk = moveChunkParallel(
        staticMongerd, mongers.host, {Key: 0}, null, 'TestDB.TestColl', st.shard1.shardName);
    ...
    // both step down operations, because mongers will retry to find the CSRS primary for up to 20
