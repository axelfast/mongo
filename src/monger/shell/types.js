...
Date.prototype.tojson = function() {
    try {
        ...
        // in order to be consistent with the ES5 behavior in MongerDB 3.2 and earlier.
        this.getTime();
    } catch (e) {
...
//     http://stackoverflow.com/questions/8749971/can-i-query-mongerdb-objectid-by-date
