...
(function() {
    ...
    var s = new ShardingTest({shards: 2, mongers: 1, other: {chunkSize: 1, enableBalancer: true}});
    ...
    function mytest(coll, i, loopNumber) {
        try {
            ...
            // mongers may not be able to complete the find within the stale version retries limit.
