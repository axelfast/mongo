...
public:
    ...
    /**
     * Determines the kind of "execution stage" that mongers would use in order to collect
    ...
    /**
     * Command implementations on mongers use this method to construct the sharded explain
    ...
    //
    // Names of mock mongers execution stages.
    //
...
private:
     ...
     *
     * The planner info will display 'mongersStageName' as the name of the execution stage
     * performed by mongers after gathering results from the shards.
     */
     ...
     *
     * Will display 'mongersStageName' as the name of the execution stage performed by mongers,
     * and 'millisElapsed' as the execution time of the mongers stage.
     */
