...
public:
    ...
    // Needed to make `std::is_convertible<monger::unique_function<...>, std::function<...>>` be
    // `std::false_type`.  `monger::unique_function` objects are not convertible to any kind of
