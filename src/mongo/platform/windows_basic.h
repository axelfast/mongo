...
#error "MongerDB requires Windows SDK 8.1 or higher to build"
#endif

#if !defined(NTDDI_WIN7) || NTDDI_VERSION < NTDDI_WIN7
#error "MongerDB does not support Windows versions older than Windows 7/Windows Server 2008 R2."
#endif
