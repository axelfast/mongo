...
/**
 * Specifies a representation of the external mongers and internal config versions of the addShard
...
public:
    ...
    static const BSONField<std::string> mongersAddShard;
    static const BSONField<std::string> mongersAddShardDeprecated;
...
private:
    ...
    // If the shard to be added is standalone, then the hostname and port of the mongerd instance to
