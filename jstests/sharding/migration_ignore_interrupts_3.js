...
(function() {
    ...
    var mongers = st.s0, admin = mongers.getDB('admin'), dbName = "testDB", ns1 = dbName + ".foo",
        ns2 = dbName + ".bar", coll1 = mongers.getCollection(ns1), coll2 = mongers.getCollection(ns2),
    ...
    var joinMoveChunk = moveChunkParallel(
        staticMongerd, st.s0.host, {a: 0}, null, coll1.getFullName(), st.shard1.shardName);
    ...
    joinMoveChunk = moveChunkParallel(
        staticMongerd, st.s0.host, {a: 0}, null, coll2.getFullName(), st.shard2.shardName);
