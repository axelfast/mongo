/**
 * Checks that:
 * 1) Issuing a metadata command through a mongers with any write concern succeeds (because we
...
(function() {
    ...
    // createDatabase
    // Don't check createDatabase against mongers: there is no createDatabase command exposed on
    // mongers; a database is created implicitly when a collection in it is created.
