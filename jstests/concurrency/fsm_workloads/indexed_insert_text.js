...
var $config = (function() {
    ...
    var text = [
        'We’re truly excited to announce the availability of the first MongerDB',
        ...
        'by participating in our MongerDB 2.8 Bug Hunt. Winners are entitled to some',
        'great prizes (details below).  MongerDB 2.8 RC0',
        ...
        'engines that seamlessly integrate with MongerDB. This opens the door for the',
        'MongerDB Community to develop a wide array of storage engines designed for',
        'specific workloads, hardware optimizations, or deployment architectures.',

        'Pluggable storage engines are first-class players in the MongerDB',
        'ecosystem. MongerDB 2.8 ships with two storage engines, both of which',
        ...
        'storage engine, WiredTiger, that fulfills our desire to make MongerDB',
        ...
        'MongerDB 2.8 includes significant improvements to concurrency, resulting',
        ...
        'Prior to 2.8, MongerDB’s concurrency model supported database',
        'level locking. MongerDB 2.8 introduces document-level locking with',
        ...
        'The improved concurrency also means that MongerDB will more',
        'fully utilize available hardware resources. So whereas CPU',
        'usage in MongerDB has been traditionally fairly low, it will',
        'now correspond more directly to system throughput.',
        'Compression',

        'The WiredTiger storage engine in MongerDB 2.8 provides',
