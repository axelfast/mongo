 ...
 *
 *  skipSharded
 *      If true, do not run this command on a mongers.
 *
 *  skipStandalone
 *      If true, do not run this command on a standalone mongerd.
 */
...
(function() {
    ...
    let viewsCommandTests = {
        ...
        getShardVersion: {
            ...
            isAdminCommand: true,
            expectFailure: true,
            skipSharded: true,  // mongers is tested in views/views_sharded.js
        },
