...
testGetCmdLineOptsMongerd({noIndexBuildRetry: ""}, expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/enable_indexbuildretry.json"},
                         expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/disable_noindexbuildretry.ini"},
                         expectedResult);
