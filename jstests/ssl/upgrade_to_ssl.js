...
var canConnectNoSSL = runMongerProgram("monger", "--port", rst.ports[0], "--eval", ";");
...
var canConnectSSL = runMongerProgram(
    "monger", "--port", rst.ports[0], "--ssl", "--sslAllowInvalidCertificates", "--eval", ";");
