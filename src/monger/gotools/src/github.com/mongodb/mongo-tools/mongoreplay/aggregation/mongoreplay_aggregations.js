//mongerreplay_aggregations.js


//max_latency_per_type returns an aggregation pipeline to view the average and max latency for each type in a 
//mongerreplay report. Latency is calculated as the amount of time between when an operation is played and when it completes
...
//average_and_peak_lag returns an aggregation pipeline to view the average and max lag for a mongerreplay report
...
//and when it actually is played in mongerreplay
...
//latency_delta returns an aggregation pipeline to view the difference in latency in two mongerreplay reports
...
//latency_delta returns an aggregation pipeline to view the difference in errors in two mongerreplay reports
...
//average_latency_compare returns a pipeline to view the average latency of each optype in different mongerreplay reports
...
//it is a helper function to execute any of the mongerreplay statics functions
