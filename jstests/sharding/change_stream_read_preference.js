...
(function() {
    ...
    const mongersDB = st.s0.getDB(dbName);
    ...
    const primaryStream = mongersColl.aggregate([{$changeStream: {fullDocument: "updateLookup"}}],
    ...
    const secondaryStream =
        mongersColl.aggregate([{$changeStream: {fullDocument: "updateLookup"}}],
