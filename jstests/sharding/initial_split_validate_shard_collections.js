...
(function() {
    ...
    assert.commandWorked(mongers.adminCommand({enableSharding: 'test'}));
    ...
    assert.eq(0, mongers.getDB('test').user.find({}).itcount());
    ...
    const configUUID = getUUIDFromConfigCollections(mongers, 'test.user');
