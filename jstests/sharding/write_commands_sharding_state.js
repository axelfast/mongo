...
(function() {
    ...
    var st = new ShardingTest({name: "write_commands", mongers: 2, shards: 2});
    ...
    // Now restart all mongerd instances, so they don't know yet that they are sharded
    st.restartShardRS(0);
    st.restartShardRS(1);

    // Now that both mongerd shards are restarted, they don't know yet that they are part of a
    // sharded
    // cluster until they get a setShardVerion command. Mongers instance s1 has stale metadata and
