...
(function() {
    ...
    function testRestrictionCreationAndEnforcement(
        ...
        var adminSession = new Monger("127.0.0.1:" + conn.port);
        ...
        // source IP.
        var externalMonger = new Monger(get_ipaddr() + ":" + conn.port);
        var externalDb = externalMonger.getDB("admin");
    ...
    var conn = MongerRunner.runMongerd({bind_ip_all: "", auth: ""});
    ...
    var st = new ShardingTest({
        ...
        keyFile: keyfile,
        other: {
            mongersOptions: {bind_ip_all: "", auth: null},
    ...
    testRestrictionCreationAndEnforcement(
        ...
        function() {},
        function() {
            sleep(40 * 1000);  // Wait for mongers user cache invalidation
        });
