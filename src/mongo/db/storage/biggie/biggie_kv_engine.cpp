...
monger::RecoveryUnit* KVEngine::newRecoveryUnit() {
...
std::unique_ptr<monger::RecordStore> KVEngine::makeTemporaryRecordStore(OperationContext* opCtx,
                                                                       StringData ident) {
    std::unique_ptr<monger::RecordStore> recordStore =
...
std::unique_ptr<monger::RecordStore> KVEngine::getRecordStore(OperationContext* opCtx,
                                                             StringData ns,
                                                             StringData ident,
                                                             const CollectionOptions& options) {
    std::unique_ptr<monger::RecordStore> recordStore;
...
std::unique_ptr<monger::SortedDataInterface> KVEngine::getSortedDataInterface(
