...
var replShouldFail = function(name, opt1, opt2) {
    ...
    // Note: this leaves running mongerd processes.
};

/**
 * Test that $lookup works with a sharded source collection. This is tested because of
 * the connections opened between mongers/shards and between the shards themselves.
 */
...
/**
 * Takes in two mongerd/mongers configuration options and runs a basic
...
function mixedShardTest(options1, options2, shouldSucceed) {
    ...
    try {
        ...
        // Test mongers talking to config servers
        ...
        // Test mongers talking to shards
