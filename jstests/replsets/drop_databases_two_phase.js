...
(function() {
    ...
    checkLog.contains(db.getMonger(), "dropping collection: " + dbNameToDrop + "." + collNameToDrop);
    checkLog.contains(db.getMonger(), "dropped 1 collection(s)");
