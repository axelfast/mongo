...
(function() {
    ...
    // Check the case where a killCursor is run as we're building a getMore batch on mongerd.
    (function() {
    ...
    (function() {
        // Run the equivalent test on the mongers. This time, we will force the shards to hang as
        // well. This is so that we can guarantee that the mongers is checking for interruption at
        // the appropriate time, and not just propagating an error it receives from the mongerds.
    ...
    // be returned. This is relevant for both mongerd and mongers.
