// Tests mongers behavior on stale database version errors received in a transaction.
//
...
(function() {
    ...
    // metadata, so mongers should exhaust its retries and implicitly abort the transaction.
