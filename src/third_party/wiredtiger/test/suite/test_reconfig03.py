#!/usr/bin/env python
#
# Public Domain 2014-2019 MongerDB, Inc.
...
# test_reconfig03.py
#    Test the connection reconfiguration operations used in the MongerDB
#    test reconfigwt.js.
class test_reconfig03(wttest.WiredTigerTestCase):
    ...
    # Reconfigure similar to MongerDB tests.  Sleep so that checkpoint
