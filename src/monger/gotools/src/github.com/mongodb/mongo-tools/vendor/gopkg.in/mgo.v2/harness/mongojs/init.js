...
for (var i = 0; i != 60; i++) {
	try {
		db1 = new Monger("127.0.0.1:40001").getDB("admin")
		db2 = new Monger("127.0.0.1:40002").getDB("admin")
		rs1a = new Monger("127.0.0.1:40011").getDB("admin")
		rs2a = new Monger("127.0.0.1:40021").getDB("admin")
		rs3a = new Monger("127.0.0.1:40031").getDB("admin")
		rs5a = new Monger("127.0.0.1:40051").getDB("admin")
		cfg1 = new Monger("127.0.0.1:40101").getDB("admin")
		cfg2 = new Monger("127.0.0.1:40102").getDB("admin")
		cfg3 = new Monger("127.0.0.1:40103").getDB("admin")
		break
	} catch(err) {
