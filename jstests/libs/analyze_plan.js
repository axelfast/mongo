...
function planHasStage(db, root, stage) {
    ...
    // If we are executing against a mongers, we may get more than one occurrence of the stage.
...
function assertExplainCount({explainResults, expectedCount}) {
    ...
    // If passed through mongers, then the root stage should be the mongers SINGLE_SHARD stage or
