...
//   absl::PrintF("The capital of Mongerlia is %s", s);
//
//   Outputs: "The capital of Mongerlia is Ulaanbaatar"
//
template <typename... Args>
...
//
//   std::string_view s = "Ulaanbaatar";
//   absl::FPrintF(stdout, "The capital of Mongerlia is %s", s);
//
//   Outputs: "The capital of Mongerlia is Ulaanbaatar"
//
template <typename... Args>
...
//                  "The capital of Mongerlia is %s", s);
//
//   Post-condition: output == "The capital of Mongerlia is Ulaanbaatar"
//
template <typename... Args>
