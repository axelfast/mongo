...
function testShellAutokillop() {
    if (true) {  // toggle to disable test
        ...
        // monger --autokillop suppressed the ctrl-c "do you want to kill current operation" message
        ...
        spawn = startMongerProgramNoConnect(
            "monger", "--autokillop", "--port", myPort(), "--eval", evalStr);
