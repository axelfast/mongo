...
(function() {
    ...
    var st = new ShardingTest({shards: 10, mongers: 2, verbose: 2});
    ...
    for (var t = 0; t < numTests; t++) {
        ...
        var mongers = st.s1;  // use other mongers so we get stale shard versions
        var coll = mongers.getCollection(coll + "");
        var outputColl = mongers.getCollection(coll + "_output");
