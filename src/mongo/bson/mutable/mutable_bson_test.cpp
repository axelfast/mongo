...
#include "monger/bson/mutable/damage_vector.h"
...
TEST(TopologyBuilding, TopDownFromScratch) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e1), monger::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e2), monger::Status::OK());
    ASSERT_EQUALS(e2.pushBack(e3), monger::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e4), monger::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e5), monger::Status::OK());
...
TEST(TopologyBuilding, AddSiblingAfter) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e2), monger::Status::OK());
    ASSERT_EQUALS(e2.pushBack(e3), monger::Status::OK());
    ASSERT_EQUALS(e3.addSiblingRight(e4), monger::Status::OK());
...
TEST(TopologyBuilding, AddSiblingBefore) {
    ...
    */
    ...
    ASSERT_EQUALS(e2.pushBack(e3), monger::Status::OK());
    ASSERT_EQUALS(e2.pushBack(e4), monger::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e5), monger::Status::OK());
    ASSERT_EQUALS(e5.addSiblingRight(e6), monger::Status::OK());
    ASSERT_EQUALS(e5.addSiblingLeft(e7), monger::Status::OK());
...
TEST(TopologyBuilding, AddSubtreeBottomUp) {
    ...
    */
    ...
    ASSERT_EQUALS(e3.pushBack(e4), monger::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e5), monger::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e6), monger::Status::OK());
    ASSERT_EQUALS(e8.pushBack(e9), monger::Status::OK());
    ASSERT_EQUALS(e8.pushBack(e10), monger::Status::OK());
    ASSERT_EQUALS(e5.pushBack(e8), monger::Status::OK());
...
TEST(TopologyBuilding, RemoveLeafNode) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e1), monger::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e2), monger::Status::OK());
    ASSERT_EQUALS(e1.remove(), monger::Status::OK());
...
TEST(TopologyBuilding, RemoveSubtree) {
    ...
    */
    ...
    ASSERT_EQUALS(e8.pushBack(e10), monger::Status::OK());
    ASSERT_EQUALS(e5.pushBack(e8), monger::Status::OK());
    ASSERT_EQUALS(e5.remove(), monger::Status::OK());
...
TEST(TopologyBuilding, RenameNode) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e1), monger::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e2), monger::Status::OK());
    ASSERT_EQUALS(e0.rename("f0"), monger::Status::OK());
...
TEST(TopologyBuilding, MoveNode) {
    ...
    */
    ...
    ASSERT_EQUALS(e3.remove(), monger::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e3), monger::Status::OK());
...
TEST(ArrayAPI, SimpleNumericArray) {
    ...
    */
    ...
    ASSERT_EQUALS(e1.pushBack(e2), monger::Status::OK());
    ASSERT_EQUALS(e1.pushBack(e3), monger::Status::OK());
    ASSERT_EQUALS(e1.pushBack(e4), monger::Status::OK());
    ASSERT_EQUALS(e1.pushBack(e5), monger::Status::OK());
    ASSERT_EQUALS(e1.pushFront(e6), monger::Status::OK());
    ASSERT_EQUALS(e1.pushFront(e7), monger::Status::OK());
    ...
    ASSERT_EQUALS(e1.popBack(), monger::Status::OK());
    ...
    ASSERT_EQUALS(e1.popFront(), monger::Status::OK());
    ...
    ASSERT_EQUALS(e1[0].setValueInt(100), monger::Status::OK());
...
TEST(Element, setters) {
    ...
    ASSERT_EQUALS(monger::Bool, t0.getType());

    t0.setValueInt(12345).transitional_ignore();
    ASSERT_EQUALS(monger::NumberInt, t0.getType());

    t0.setValueLong(12345LL).transitional_ignore();
    ASSERT_EQUALS(monger::NumberLong, t0.getType());

    t0.setValueTimestamp(monger::Timestamp()).transitional_ignore();
    ASSERT_EQUALS(monger::bsonTimestamp, t0.getType());

    t0.setValueDate(monger::Date_t::fromMillisSinceEpoch(12345LL)).transitional_ignore();
    ASSERT_EQUALS(monger::Date, t0.getType());

    t0.setValueDouble(123.45).transitional_ignore();
    ASSERT_EQUALS(monger::NumberDouble, t0.getType());

    t0.setValueDecimal(monger::Decimal128("123.45E1234")).transitional_ignore();
    ASSERT_EQUALS(monger::NumberDecimal, t0.getType());

    t0.setValueOID(monger::OID("47cc67093475061e3d95369d")).transitional_ignore();
    ASSERT_EQUALS(monger::jstOID, t0.getType());

    t0.setValueRegex("[a-zA-Z]?", "").transitional_ignore();
    ASSERT_EQUALS(monger::RegEx, t0.getType());

    t0.setValueString("foo bar baz").transitional_ignore();
    ASSERT_EQUALS(monger::String, t0.getType());
}

TEST(Element, toString) {
    monger::BSONObj obj = monger::fromjson("{ a : 1, b : [1, 2, 3], c : { x : 'x' } }");
    mmb::Document doc(obj);
    ...
    // 'a'
    monger::BSONObjIterator iter(obj);
...
TEST(DecimalType, createElement) {
    ...
    mmb::Element d0 = doc.makeElementDecimal("d0", monger::Decimal128("12345"));
    ASSERT_TRUE(monger::Decimal128("12345").isEqual(d0.getValueDecimal()));
}

TEST(DecimalType, setElement) {
    mmb::Document doc;

    mmb::Element d0 = doc.makeElementDecimal("d0", monger::Decimal128("128"));
    d0.setValueDecimal(monger::Decimal128("123456")).transitional_ignore();
    ASSERT_TRUE(monger::Decimal128("123456").isEqual(d0.getValueDecimal()));

    d0.setValueDouble(0.1).transitional_ignore();
    ASSERT_EQUALS(0.1, d0.getValueDouble());
    d0.setValueDecimal(monger::Decimal128("23")).transitional_ignore();
    ASSERT_TRUE(monger::Decimal128("23").isEqual(d0.getValueDecimal()));
}
...
TEST(DecimalType, appendElement) {
    ...
    d0.appendDecimal("precision", monger::Decimal128(34)).transitional_ignore();

    mmb::Element it = mmb::findFirstChildNamed(d0, "precision");
    ASSERT_TRUE(it.ok());
    ASSERT_TRUE(monger::Decimal128(34).isEqual(it.getValueDecimal()));
}

TEST(TimestampType, createElement) {
    mmb::Document doc;

    mmb::Element t0 = doc.makeElementTimestamp("t0", monger::Timestamp());
    ASSERT(monger::Timestamp() == t0.getValueTimestamp());

    mmb::Element t1 = doc.makeElementTimestamp("t1", monger::Timestamp(123, 456));
    ASSERT(monger::Timestamp(123, 456) == t1.getValueTimestamp());
}
...
TEST(TimestampType, setElement) {
    ...
    mmb::Element t0 = doc.makeElementTimestamp("t0", monger::Timestamp());
    t0.setValueTimestamp(monger::Timestamp(123, 456)).transitional_ignore();
    ASSERT(monger::Timestamp(123, 456) == t0.getValueTimestamp());
    ...
    t0.setValueTimestamp(monger::Timestamp(789, 321)).transitional_ignore();
    ASSERT(monger::Timestamp(789, 321) == t0.getValueTimestamp());

    t0.setValueString("foo bar baz").transitional_ignore();
    ASSERT_EQUALS("foo bar baz", t0.getValueString());
    t0.setValueTimestamp(monger::Timestamp(9876, 5432)).transitional_ignore();
    ASSERT(monger::Timestamp(9876, 5432) == t0.getValueTimestamp());
}
...
TEST(TimestampType, appendElement) {
    ...
    t0.appendTimestamp("a timestamp field", monger::Timestamp(1352151971, 471))
        .transitional_ignore();

    mmb::Element it = mmb::findFirstChildNamed(t0, "a timestamp field");
    ASSERT_TRUE(it.ok());
    ASSERT(monger::Timestamp(1352151971, 471) == it.getValueTimestamp());
}

TEST(SafeNumType, createElement) {
    mmb::Document doc;

    mmb::Element t0 = doc.makeElementSafeNum("t0", monger::SafeNum(123.456));
    ASSERT_EQUALS(monger::SafeNum(123.456), t0.getValueSafeNum());
}
...
TEST(SafeNumType, getSafeNum) {
    ...
    monger::SafeNum num = t0.getValueSafeNum();
    ...
    t0.setValueDecimal(monger::Decimal128("12345678.1234")).transitional_ignore();
    ASSERT_TRUE(monger::Decimal128("12345678.1234").isEqual(t0.getValueDecimal()));
    num = t0.getValueSafeNum();
    ASSERT_EQUALS(num, monger::Decimal128("12345678.1234"));
}

TEST(SafeNumType, setSafeNum) {
    mmb::Document doc;

    mmb::Element t0 = doc.makeElementSafeNum("t0", monger::SafeNum(123456));
    t0.setValueSafeNum(monger::SafeNum(654321)).transitional_ignore();
    ASSERT_EQUALS(monger::SafeNum(654321), t0.getValueSafeNum());

    // Try setting to other types and back to SafeNum
    t0.setValueLong(1234567890).transitional_ignore();
    ASSERT_EQUALS(1234567890LL, t0.getValueLong());
    t0.setValueSafeNum(monger::SafeNum(1234567890)).transitional_ignore();
    ASSERT_EQUALS(monger::SafeNum(1234567890), t0.getValueSafeNum());

    t0.setValueString("foo bar baz").transitional_ignore();

    monger::StringData left = "foo bar baz";
    monger::StringData right = t0.getValueString();
    ASSERT_EQUALS(left, right);

    ASSERT_EQUALS(monger::StringData("foo bar baz"), t0.getValueString());
    t0.setValueSafeNum(monger::SafeNum(12345)).transitional_ignore();
    ASSERT_EQUALS(monger::SafeNum(12345), t0.getValueSafeNum());
}
...
TEST(SafeNumType, appendElement) {
    ...
    mmb::Element t0 = doc.makeElementObject("e0");
    t0.appendSafeNum("a timestamp field", monger::SafeNum(static_cast<int64_t>(1352151971LL)))
        .transitional_ignore();

    mmb::Element it = findFirstChildNamed(t0, "a timestamp field");
    ASSERT_TRUE(it.ok());
    ASSERT_EQUALS(monger::SafeNum(static_cast<int64_t>(1352151971LL)), it.getValueSafeNum());
}

TEST(OIDType, getOidValue) {
    mmb::Document doc;
    mmb::Element t0 = doc.makeElementObject("e0");
    const monger::OID generated = monger::OID::gen();
    t0.appendOID("myOid", generated).transitional_ignore();
    mmb::Element it = findFirstChildNamed(t0, "myOid");
    const monger::OID recovered = monger::OID(it.getValueOID());
...
TEST(OIDType, nullOID) {
    mmb::Document doc;
    mmb::Element t0 = doc.makeElementObject("e0");
    const monger::OID withNull("50a9c82263e413ad0028faad");
...
TEST(Serialization, RoundTrip) {
    monger::BSONObj obj;
    obj = monger::fromjson(jsonSampleWithDecimal);
    mmb::Document doc(obj.copy());
    monger::BSONObj built = doc.getObject();
...
TEST(Documentation, Example1) {
    ...
    mmb::Document doc;
    ASSERT_BSONOBJ_EQ(monger::fromjson("{}"), doc.getObject());

    // Get the root of the document.
    mmb::Element root = doc.root();

    // Create a new monger::NumberInt typed Element to represent life, the universe, and
    ...
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ ltuae : 42 }"), doc.getObject());

    // Create a new empty monger::Object-typed Element named 'magic', and push it back as a
    // child of the root, making it a sibling of e0.
    mmb::Element e1 = doc.makeElementObject("magic");
    ASSERT_OK(root.pushBack(e1));
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ ltuae : 42, magic : {} }"), doc.getObject());

    // Create a new monger::NumberDouble typed Element to represent Pi, and insert it as child
    // of the new object we just created.
    mmb::Element e3 = doc.makeElementDouble("pi", 3.14);
    ASSERT_OK(e1.pushBack(e3));
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ ltuae : 42, magic : { pi : 3.14 } }"), doc.getObject());

    // Create a new monger::NumberDouble to represent Plancks constant in electrovolt
    ...
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ ltuae : 42, magic : { pi : 3.14, hbar : 1.239 } }"),
                      doc.getObject());

    // Rename the parent element of 'hbar' to be 'constants'.
    ASSERT_OK(e4.parent().rename("constants"));
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ ltuae : 42, constants : { pi : 3.14, hbar : 1.239 } }"),
                      doc.getObject());

    // Rename 'ltuae' to 'answer' by accessing it as the root objects left child.
    ASSERT_OK(doc.root().leftChild().rename("answer"));
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ answer : 42, constants : { pi : 3.14, hbar : 1.239 } }"),
                      doc.getObject());

    // Sort the constants by name.
    mmb::sortChildren(doc.root().rightChild(), mmb::FieldNameLessThan());
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ answer : 42, constants : { hbar : 1.239, pi : 3.14 } }"),
                      doc.getObject());
}
...
TEST(Documentation, Example2) {
    static const char inJson[] =
        ...
        "}";
    monger::BSONObj obj = monger::fromjson(inJson);
    ...
    // Construct a new monger::Object element for the ex-whale.
    ...
    doc.writeTo(&builder);
    ASSERT_BSONOBJ_EQ(monger::fromjson(outJson), doc.getObject());
}

namespace {
void apply(monger::BSONObj* obj, const mmb::DamageVector& damages, const char* source) {
...
TEST(Documentation, Example2InPlaceWithDamageVector) {
    ...
    monger::BSONObj obj = monger::fromjson(inJson);
    const monger::BSONObj copyOfObj = obj.getOwned();
    ...
    static const char outJson[] =
        ...
        "}";
    monger::BSONObj outObj = monger::fromjson(outJson);
...
TEST(Documentation, Example3) {
    static const char inJson[] =
        ...
        "  'ys': { 'y' : 'y' }"
        "}";
    monger::BSONObj inObj = monger::fromjson(inJson);
    ...
    monger::BSONObj outObj = doc.getObject();
    ...
    static const char outJson[] =
        ...
        "  'ys': { 'y' : 'y', 'Y' : 'Y', 'why' : ['not'] }"
        "}";
    ASSERT_BSONOBJ_EQ(monger::fromjson(outJson), outObj);
}
...
TEST(Document, LifecycleConstructDefault) {
    ...
    ASSERT_TRUE(doc.root().isType(monger::Object));
...
TEST(Document, LifecycleConstructSimpleBSONObj) {
    ...
    // simple (flat) BSONObj.
    monger::BSONObj obj = monger::fromjson("{ e1: 1, e2: 'hello', e3: false }");
    mmb::Document doc(obj);
    ...
    ASSERT_TRUE(e1Child.isType(monger::NumberInt));
    ...
    ASSERT_TRUE(e2Child.isType(monger::String));
    ...
    ASSERT_TRUE(e3Child.isType(monger::Bool));
...
TEST(Document, ArrayIndexedAccessFromJson) {
    ...
    ASSERT_EQUALS(monger::NumberInt, a.getType());

    mmb::Element b = a.rightSibling();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS("b", b.getFieldName());
    ASSERT_EQUALS(monger::Array, b.getType());

    mmb::Element b0 = b[0];
    ASSERT_TRUE(b0.ok());
    ASSERT_EQUALS("0", b0.getFieldName());
    ASSERT_EQUALS(monger::Object, b0.getType());
}
...
TEST(Document, AddChildToEmptyOpaqueSubobject) {
    monger::BSONObj inObj = monger::fromjson("{a: {}}");
    mmb::Document doc(inObj);
...
TEST(Element, IsNumeric) {
    ...
    elt = doc.makeElementDecimal("dummy", monger::Decimal128(20));
    ASSERT_TRUE(elt.isNumeric());
}
...
TEST(Document, ArraySerialization) {
    ...
    const monger::BSONObj outObj = doc.getObject();
    ASSERT_BSONOBJ_EQ(monger::fromjson(outJson), outObj);
}
...
TEST(Document, SetValueBSONElementFieldNameHandling) {
    ...
    monger::BSONObj inObj2 = monger::fromjson(inJson2);
    monger::BSONObjIterator iterator(inObj2);

    ASSERT_TRUE(iterator.more());
    const monger::BSONElement b = iterator.next();
...
TEST(Document, SetValueElementFromSeparateDocument) {
    monger::BSONObj inObj = monger::fromjson("{ a : 4 }");
    mmb::Document doc1(inObj);

    monger::BSONObj inObj2 = monger::fromjson("{ b : 5 }");
    ...
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ a : 5 }"), doc1.getObject());
...
TEST(Document, SetValueElementIsNoopWhenSetToSelfNonRootElement) {
    monger::BSONObj inObj = monger::fromjson("{ a : { b : { c: 4 } } }");
    mmb::Document doc(inObj);
...
TEST(Document, SetValueElementSetToNestedObject) {
    ...
    monger::BSONObj inObj2 = monger::fromjson("{ b : { c : 5, d : 6 } }");
    const mmb::Document doc2(inObj2);
    ...
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ a : { c : 5, d : 6 } }"), doc1.getObject());
...
TEST(Document, SetValueElementNonRootElements) {
    monger::BSONObj inObj = monger::fromjson("{ a : { b : 5, c : 6 } }");
    mmb::Document doc1(inObj);

    monger::BSONObj inObj2 = monger::fromjson("{ d : { e : 8, f : 9 } }");
    const mmb::Document doc2(inObj2);
    ...
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ a : { b : 5, c : 8 } }"), doc1.getObject());
...
TEST(Document, SetValueElementSetToOwnRootErrors) {
    monger::BSONObj inObj = monger::fromjson("{ a : { b : 4 } }");
    mmb::Document doc(inObj);
...
TEST(Document, SetValueElementSetToOtherDocRoot) {
    ...
    monger::BSONObj inObj2 = monger::fromjson("{ c : 5 } }");
    ...
    ASSERT_OK(setTo.setValueElement(setFrom));
    ASSERT_BSONOBJ_EQ(monger::fromjson("{ a : { b : { c : 5 } } }"), doc1.getObject());
    ASSERT_BSONOBJ_EQ(inObj2, doc2.getObject());
}

TEST(Document, CreateElementWithEmptyFieldName) {
    mmb::Document doc;
    mmb::Element noname = doc.makeElementObject(monger::StringData());
    ASSERT_TRUE(noname.ok());
    ASSERT_EQUALS(monger::StringData(), noname.getFieldName());
}

TEST(Document, CreateElementFromBSONElement) {
    monger::BSONObj obj = monger::fromjson("{a:1}}");
    mmb::Document doc;
    ASSERT_OK(doc.root().appendElement(obj["a"]));

    mmb::Element newElem = doc.root()["a"];
    ASSERT_TRUE(newElem.ok());
    ASSERT_EQUALS(newElem.getType(), monger::NumberInt);
...
TEST(Document, toStringComplex) {
    monger::BSONObj obj = monger::fromjson("{a : 1, b : [1, 2, 3], c : 'c'}");
    mmb::Document doc(obj);
    ASSERT_EQUALS(obj.toString(), doc.toString());
}
...
TEST(Document, toStringEphemeralObject) {
    ...
    ASSERT_EQUALS(monger::fromjson("{ foo: { d : 1.0, s : 'str' } }").firstElement().toString(),
                  e.toString());
}
...
TEST(Document, toStringEphemeralArray) {
    ...
    ASSERT_OK(doc.root().pushBack(e));
    ASSERT_OK(e.appendDouble(monger::StringData(), 1.0));
    ASSERT_OK(e.appendString(monger::StringData(), "str"));
    ASSERT_EQUALS(monger::fromjson("{ foo: [ 1.0, 'str' ] }").firstElement().toString(),
                  e.toString());
}
...
TEST(Document, ElementCloningToDifferentDocument) {
    ...
    mmb::Document source(monger::fromjson(initial));

    // Dirty the 'd' node and parents.
    source.root()["d"]
        .pushBack(source.makeElementInt(monger::StringData(), 7))
        .transitional_ignore();
    ...
    monger::Status status = target.root().pushBack(newElement);
    ASSERT_OK(status);
    const char* expected = "{ d : [ 4, 5, 6, 7 ] }";
    ASSERT_EQUALS(monger::fromjson(expected), target);
...
TEST(Document, ElementCloningToSameDocument) {
    ...
    mmb::Document doc(monger::fromjson(initial));

    // Dirty the 'd' node and parents.
    doc.root()["d"].pushBack(doc.makeElementInt(monger::StringData(), 7)).transitional_ignore();

    mmb::Element newElement = doc.makeElement(doc.root()["d"]);
    ASSERT_TRUE(newElement.ok());
    monger::Status status = doc.root().pushBack(newElement);
    ASSERT_OK(status);
    const char* expected =
        "{ "
        ...
        " d : [ 4, 5, 6, 7 ] "
        "}";
    ASSERT_EQUALS(monger::fromjson(expected), doc);
...
TEST(Document, NameOfRootElementIsEmpty) {
    ...
    ASSERT_EQUALS(monger::StringData(), doc.root().getFieldName());
}
...
TEST(Document, ValueOfEphemeralObjectElementIsEmpty) {
    ...
    // NOTE: You really shouldn't rely on this behavior; this test is mostly for coverage.
    ASSERT_BSONELT_EQ(monger::BSONElement(), ephemeralObject.getValue());
}
...
TEST(Element, RemovingRemovedElementFails) {
    ...
    mmb::Document doc(monger::fromjson("{ a : { b : 'c' } }"));
    mmb::Element a = doc.root().leftChild();
    ASSERT_TRUE(a.ok());
    ASSERT_OK(a.remove());
...
bool identical(const monger::BSONElement& lhs, const monger::BSONElement& rhs) {
...
TEST(TypeSupport, EncodingEquivalenceDouble) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::NumberDouble);
    ...
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::NumberDouble);
    ...
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::NumberDouble);
    ...
    ASSERT_EQUALS(c.getType(), monger::NumberDouble);
...
TEST(TypeSupport, EncodingEquivalenceString) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::String);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::String);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::String);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::String);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceObject) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::BSONObj value1 = monger::fromjson("{ a : 1, b : 2.0, c : 'hello' }");
    builder.append(name, value1);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Object);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Object);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Object);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Object);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceArray) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::BSONObj dummy = (monger::fromjson("{ x : [ 1, 2.0, 'hello' ] } "));
    const monger::BSONArray value1(dummy.firstElement().embeddedObject());
    builder.append(name, value1);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Array);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Array);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Array);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Array);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceBinary) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::BinDataType value1 = monger::newUUID;
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::BinData);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::BinData);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::BinData);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::BinData);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceUndefined) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Undefined);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Undefined);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Undefined);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Undefined);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceOID) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::OID value1 = monger::OID::gen();
    builder.append(name, value1);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::jstOID);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::jstOID);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::jstOID);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::jstOID);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceBoolean) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Bool);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Bool);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Bool);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Bool);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceDate) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::Date_t value1 = monger::jsTime();
    builder.append(name, value1);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Date);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Date);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Date);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Date);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceNull) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::jstNULL);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::jstNULL);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::jstNULL);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::jstNULL);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceRegex) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::RegEx);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::RegEx);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::RegEx);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::RegEx);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceDBRef) {
    ...
    const monger::OID value2 = monger::OID::gen();
    builder.appendDBRef(name, value1, value2);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::DBRef);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::DBRef);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::DBRef);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::DBRef);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceCode) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Code);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Code);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Code);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Code);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceSymbol) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::Symbol);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::Symbol);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::Symbol);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::Symbol);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceCodeWithScope) {
    ...
    const monger::BSONObj value2 = monger::fromjson("{ x : 4 }");
    builder.appendCodeWScope(name, value1, value2);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::CodeWScope);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::CodeWScope);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::CodeWScope);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::CodeWScope);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceInt) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::NumberInt);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::NumberInt);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::NumberInt);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::NumberInt);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceTimestamp) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::Timestamp value1 = monger::Timestamp(monger::jsTime());
    builder.append(name, value1);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::bsonTimestamp);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::bsonTimestamp);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::bsonTimestamp);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::bsonTimestamp);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceLong) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::NumberLong);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::NumberLong);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::NumberLong);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::NumberLong);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceDecimal) {
    monger::BSONObjBuilder builder;
    const char name[] = "thing";
    const monger::Decimal128 value1 = monger::Decimal128(2);
    builder.append(name, value1);
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::NumberDecimal);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::NumberDecimal);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::NumberDecimal);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::NumberDecimal);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceMinKey) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::MinKey);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::MinKey);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::MinKey);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::MinKey);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceMaxKey) {
    ...
    monger::BSONObj source = builder.done();
    const monger::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == monger::MaxKey);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), monger::MaxKey);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), monger::MaxKey);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), monger::MaxKey);
    ASSERT_TRUE(c.hasValue());
...
TEST(Document, ManipulateComplexObjInLeafHeap) {
    ...
    mmb::Element embedded = doc.makeElementObject("embedded", monger::fromjson(inJson));
...
TEST(DocumentInPlace, InPlaceModeIsDisabledByAddSiblingLeft) {
    monger::BSONObj obj = monger::fromjson("{ foo : 'foo' }");
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
...
TEST(DocumentInPlace, InPlaceModeIsDisabledByIncompatibleSetValue) {
    monger::BSONObj obj(monger::fromjson("{ foo : false }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
...
TEST(DocumentInPlace, DisablingInPlaceDoesNotDiscardUpdates) {
    monger::BSONObj obj(monger::fromjson("{ foo : false, bar : true }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
...
TEST(DocumentInPlace, StringLifecycle) {
    monger::BSONObj obj(monger::fromjson("{ x : 'foo' }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    ASSERT_TRUE(x.isType(monger::String));
...
TEST(DocumentInPlace, BinDataLifecycle) {
    ...
    const monger::BSONBinData binData1(kData1, sizeof(kData1) - 1, monger::BinDataGeneral);
    const monger::BSONBinData binData2(kData2, sizeof(kData2) - 1, monger::bdtCustom);

    monger::BSONObj obj(BSON("x" << binData1));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::BinData));

    monger::BSONElement value = x.getValue();
...
TEST(DocumentInPlace, OIDLifecycle) {
    const monger::OID oid1 = monger::OID::gen();
    const monger::OID oid2 = monger::OID::gen();
    ASSERT_NOT_EQUALS(oid1, oid2);

    monger::BSONObj obj(BSON("x" << oid1));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::jstOID));
...
TEST(DocumentInPlace, BooleanLifecycle) {
    monger::BSONObj obj(monger::fromjson("{ x : false }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::Bool));
...
TEST(DocumentInPlace, DateLifecycle) {
    monger::BSONObj obj(BSON("x" << monger::Date_t::fromMillisSinceEpoch(1000)));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    x.setValueDate(monger::Date_t::fromMillisSinceEpoch(20000)).transitional_ignore();
    ASSERT_TRUE(doc.getInPlaceUpdates(&damages, &source));
    ASSERT_EQUALS(1U, damages.size());
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::Date));
    ASSERT_EQUALS(monger::Date_t::fromMillisSinceEpoch(20000), x.getValueDate());
...
TEST(DocumentInPlace, NumberIntLifecycle) {
    const int value1 = 42;
    const int value2 = 3;
    monger::BSONObj obj(BSON("x" << value1));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::NumberInt));
...
TEST(DocumentInPlace, TimestampLifecycle) {
    monger::BSONObj obj(BSON("x" << monger::Timestamp(monger::Date_t::fromMillisSinceEpoch(1000))));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    x.setValueTimestamp(monger::Timestamp(monger::Date_t::fromMillisSinceEpoch(20000)))
        .transitional_ignore();
    ASSERT_TRUE(doc.getInPlaceUpdates(&damages, &source));
    ASSERT_EQUALS(1U, damages.size());
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::bsonTimestamp));
    ASSERT_TRUE(monger::Timestamp(20000U) == x.getValueTimestamp());
...
TEST(DocumentInPlace, NumberLongLifecycle) {
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::NumberLong));
...
TEST(DocumentInPlace, NumberDoubleLifecycle) {
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::NumberDouble));
...
TEST(DocumentInPlace, NumberDecimalLifecycle) {
    const monger::Decimal128 value1 = monger::Decimal128(32);
    const monger::Decimal128 value2 = monger::Decimal128(2);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(monger::NumberDecimal));
...
TEST(DocumentComparison, SimpleComparison) {
    const monger::BSONObj obj =
        monger::fromjson("{ a : 'a', b : ['b', 'b', 'b'], c : { one : 1.0 } }");
...
TEST(DocumentComparison, DocumentCompareWithRespectsCollation) {
    monger::CollatorInterfaceMock collator(monger::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(monger::fromjson("{a: 'foo'}"));
    const mmb::Document doc2(monger::fromjson("{a: 'bar'}"));
...
TEST(DocumentComparison, DocumentCompareWithBSONObjRespectsCollation) {
    monger::CollatorInterfaceMock collator(monger::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(monger::fromjson("{a: 'foo'}"));
    const monger::BSONObj doc2 = monger::fromjson("{a: 'bar'}");
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
...
TEST(DocumentComparison, ElementCompareWithBSONElementRespectsCollator) {
    ...
    const monger::BSONObj doc2 = monger::fromjson("{a: 'bar'}");
    const mmb::ConstElement element1 = doc1.root().leftChild();
    const monger::BSONElement element2 = doc2["a"];
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
...
TEST(DocumentComparison, ElementCompareWithBSONObjRespectsCollator) {
    monger::CollatorInterfaceMock collator(monger::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(monger::fromjson("{b: {c: 'foo'}}"));
    const monger::BSONObj doc2 = monger::fromjson("{c: 'bar'}");
    const mmb::ConstElement element1 = doc1.root().leftChild();
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
...
TEST(DocumentComparison, DocumentCompareWithRespectsCollationRecursively) {
    monger::CollatorInterfaceMock collator(monger::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(monger::fromjson("{a: [{b: 'foo'}, {b: 'bar'}]}"));
    const mmb::Document doc2(monger::fromjson("{a: [{b: 'notFoo'}, {b: 'notBar'}]}"));
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
    ASSERT_NE(0, doc1.compareWith(doc2, nullptr, true));
    ASSERT_EQ(0, doc1.compareWith(doc2, &collator, true));
...
TEST(DocumentComparison, DocumentCompareWithRespectsCollationWithDeserializedElement) {
    monger::CollatorInterfaceMock collator(monger::CollatorInterfaceMock::MockType::kAlwaysEqual);
    mmb::Document doc1(monger::fromjson("{a: ['foo', 'foo']}"));
    mmb::Document doc2(monger::fromjson("{a: ['bar', 'bar']}"));
...
TEST(UnorderedEqualityChecker, Identical) {
    const monger::BSONObj b1 =
        monger::fromjson("{ a : [1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");

    const monger::BSONObj b2 = b1.getOwned();
...
TEST(UnorderedEqualityChecker, DifferentValuesAreNotEqual) {
    const monger::BSONObj b1 =
        monger::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const monger::BSONObj b2 =
        monger::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 4 } }");
...
TEST(UnorderedEqualityChecker, DifferentTypesAreNotEqual) {
    const monger::BSONObj b1 =
        monger::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const monger::BSONObj b2 = monger::fromjson(
...
TEST(UnorderedEqualityChecker, MissingFieldsInObjectAreNotEqual) {
    const monger::BSONObj b1 =
        monger::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const monger::BSONObj b2 =
        monger::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, z : 3 } }");
...
TEST(UnorderedEqualityChecker, ArrayOrderingIsConsidered) {
    ...
    const monger::BSONObj b2 =
        monger::fromjson("{ a : [ 1, { 'a' : 'b', 'x' : 'y' }, 2 ], b : { x : 1, y : 2, z : 3 } }");
...
TEST(UnorderedEqualityChecker, MissingItemsInArrayAreNotEqual) {
    const monger::BSONObj b1 =
        monger::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const monger::BSONObj b2 =
        monger::fromjson("{ a : [ 1, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, z : 3 } }");
