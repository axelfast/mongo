...
testGetCmdLineOptsMongerd({replSet: "mycmdlinename"}, expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/set_replsetname.json"},
                         expectedResult);
