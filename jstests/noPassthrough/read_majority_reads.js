...
(function() {
    ...
    function runTests(coll, mongerdConnection) {
    ...
    var mongerd = replTest.getPrimary();

    (function testSingleNode() {
        var db = mongerd.getDB("singleNode");
    ...
    // Remove tests of commands that aren't supported at all through mongers, even on unsharded
    // collections.
