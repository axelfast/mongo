...
TEST(ShellOptions, RedactPasswords) {
    std::vector<std::pair<std::vector<std::string>, const std::vector<StringData>>> testData = {
        ...
        {{"-p", "password", "mongerdb://admin:password@localhost"},  // NOLINT
         {"-p"_sd, "xxxxxxxx", "mongerdb://admin@localhost"_sd}},    // NOLINT
        // Check that just URIs get redacted correctly
        {{"mongerdb://admin:password@localhost"},  // NOLINT
         {"mongerdb://admin@localhost"_sd}},       // NOLINT
        ...
        // prompt for password
        {{"mongerdb://admin@localhost/admin", "--password"},         // NOLINT
         {"mongerdb://admin@localhost/admin"_sd, "--password"_sd}},  // NOLINT
    };
