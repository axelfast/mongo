// Verifies mongers returns StaleConfig if it exhausts its allowed stale version retry attempts,
...
(function() {
    ...
    assert(testDB.getMonger().readMode() === "commands");
    assert(testDB.getMonger().writeMode() === "commands");
    ...
    kCommands.forEach((cmd) => {
        // The recipient shard should return StaleConfig until mongers exhausts its retries and
