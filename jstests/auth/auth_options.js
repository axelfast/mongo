...
testGetCmdLineOptsMongerd({auth: ""}, expectedResult);

jsTest.log("Testing \"noauth\" command line option");
expectedResult = {
    "parsed": {"security": {"authorization": "disabled"}}
};
testGetCmdLineOptsMongerd({noauth: ""}, expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/enable_auth.json"}, expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/disable_auth.ini"}, expectedResult);
...
testGetCmdLineOptsMongerd({config: "jstests/libs/config_files/disable_noauth.ini"}, expectedResult);
