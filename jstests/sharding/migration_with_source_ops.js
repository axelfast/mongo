...
(function() {
    ...
    var mongers = st.s0, admin = mongers.getDB('admin'), dbName = "testDB", ns = dbName + ".foo",
        coll = mongers.getCollection(ns), donor = st.shard0, recipient = st.shard1,
    ...
    var joinMoveChunk = moveChunkParallel(
        staticMongerd, st.s0.host, {a: 20}, null, coll.getFullName(), st.shard1.shardName);
